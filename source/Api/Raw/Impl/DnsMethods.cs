...
{
    internal class DnsMethods : MethodsBase, IDnsMethods
    {
        internal DnsMethods(DomainRawContext context) : base(context) { }

        public async Task<string> Add(AddDnsRecord record) =>
        ...
        public async Task<string> Edit(DnsRecord record)
            =>
                await
